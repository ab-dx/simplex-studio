export default function CodeEditor({ code, onCodeChange, onAssemble, onEmulate, disabled }) {
  return (
    <div className="bg-card border border-border rounded-xl p-6 flex flex-col gap-4 shadow-sm">
      <div>
        ...
        <p className="text-xs text-muted-foreground">Write your assembly code below</p>
      </div>
      <textarea
        value={code}
